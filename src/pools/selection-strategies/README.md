...
During a round, if worker weight is inferior to the current round, the task is assigned to the next worker. Once the all workers have been assigned a task, the next round starts.  
